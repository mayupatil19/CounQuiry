...
import com.example.hp.coun.mGridViewData.CategoryDam;
import com.example.hp.coun.mGridViewData.CategoryOcean;

import java.util.ArrayList;

public class GridViewAdapterDams extends BaseAdapter {
    ArrayList<CategoryDam> cl;
    Context ctx;
    // LayoutInflater inflater;
    public GridViewAdapterDams(Context ctx, ArrayList<CategoryDam> cl)
    {
        this.ctx=ctx;
        this.cl=cl;
    ...
    public View getView(final int position, View view, ViewGroup parent)
    {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(ctx, country.class);
